  ...
  <div class="word-grouping-game">
    ...
    <div v-if="showModal" class="modal">
      <div class="modal-content">
        <svg fill="#4CAF50" height="auto" width="80px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
        ...
        <p style="color: red; font-weight: bold;">Save the dates and don't ruin the surprise for your siblings!</p>
        <p>This year, you're getting your Christmas gift early.</p>
        <p>You are cordially invited to join us for an <br>
          <strong>all-inclusive Winter vacation in Puerto Vallarta</strong>!</p>
        <div class="info">
          <p>Dates: December 18 - 24</p>
          <p>Airline: Alaska Airlines</p>
          <p>Hotel: <a href="https://www.hilton.com/en/hotels/pvrpahh-hilton-vallarta-riviera-all-inclusive-resort/resort/" target="_blank">Hilton Vallarta Riviera All-Inclusive Resort</a></p>
        </div>
